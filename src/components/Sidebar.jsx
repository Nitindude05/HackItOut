  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="px-3 py-4"
          style={{ borderTop: isDark ? "1px solid rgba(201,169,122,0.1)" : "1px solid rgba(44,26,14,0.1)" }}
        >
          {/* Status row */}
          <AnimatePresence>
            {!collapsed && (
              <motion.div
                ...
                style={{
                  ...
                  borderRadius: 10,
                  marginBottom: 8,
                  background: isDark ? "rgba(76,175,80,0.06)" : "rgba(74,92,58,0.07)",
                  border: "1px solid",
                  borderColor: isDark ? "rgba(76,175,80,0.15)" : "rgba(74,92,58,0.15)",
                }}
              >
                <span className="clima-status-dot" />
                <span style={{ fontSize: 12, color: isDark ? "rgba(201,169,122,0.65)" : "rgba(44,26,14,0.55)" }}>
                  Backend connected
                </span>
              </motion.div>
            )}
